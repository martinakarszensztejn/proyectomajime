                    ...
                    Else
                        ...
                        Try
                            ...
                            ElseIf dueño.Chars(8) = " " Then
                                ...
                                ciownerInt = Integer.Parse(ciowner)
                            End If
                            Dim sentenciaRel As String = "INSERT INTO `majime`.`pertenece` (`num_mascota`,`ci_cliente`) VALUES((Select num_mascota FROM `majime`.`mascota` ORDER BY num_mascota DESC LIMIT 1 ),(" & ciownerInt & "));"
