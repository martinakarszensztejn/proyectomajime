                                                            ...
                                                            If CheckBoxIda.Checked = True Then
                                                                ...
                                                                For index = 0 To nomMascSelectedList.Count - 1
                                                                    ...
                                                                    Catch ex As Exception
                                                                        ...
                                                                        MsgBox("Error en el proceso de agregar el traslado de IDA. ")
                                                                    End Try
                                                                Next
                                                            ...
                                                            If CheckBoxVuelta.Checked = True Then
                                                                ...
                                                                For j = 0 To nomMascSelectedList.Count - 1
                                                                    ...
                                                                    Try
                                                                        ...
                                                                        Dim sentenciaTransVue As String

                                                                        sentenciaTransVue = "INSERT INTO `mkarszensztejn`.`transporta` (`num_mascota`, `momento_creado_transporte`, `matricula_camioneta`, `momento_inicio_transporte`, `momento_fin_transporte`) SELECT (SELECT num_mascota FROM mascota WHERE nombre_mascota = '" & nomMascCorrectedList.ElementAt(j) & "'), '" & fechaActual & segundero & "', '" & potencialAutoListVuelta.ElementAt(0) & "', '" & vueltaDateInicioSQLFormat & "', '" & vueltaDateFinSQLFormat & "';"




                                                                        comandou = New MySqlCommand(sentenciaTransVue, Guau.conk)
                                                                    ...
                                                                    Catch ex As Exception
                                                                        ...
                                                                        MsgBox("Error en el proceso de agregar el traslado de vuelta. ")
                                                                    End Try


                                                                Next
                                                            End If
                                                            If (CheckBoxIda.Checked = True AndAlso exitoAgregadoTransIda = True) Or (CheckBoxVuelta.Checked = True AndAlso exitoAgregadoTransVuelta) Then
