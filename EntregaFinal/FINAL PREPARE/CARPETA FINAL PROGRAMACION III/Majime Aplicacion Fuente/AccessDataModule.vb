...
Module AccessDataModule
    ...
    Friend Function GetTransporteByID(num_masc As Integer) As Object
        Dim consulta As String
        consulta = "Select * From transporta WHERE num_mascota = " & num_masc & ";"
        ...
        Dim selectedTrans As Transporta
        Try
            While drd.HasRows()


                While drd.Read()
                    selectedTrans = New Transporta(drd.GetInt32(0), drd.GetString(1), drd.GetString(2), drd.GetString(3), drd.GetString(4))
    ...
    Public Function GetPetByID(idQuery As Integer) As Mascota
        Dim consulta As String
        consulta = "Select * From mascota WHERE num_mascota = " & idQuery & ";"
        ...
        Try
            ...
            While drd.HasRows()
                ...
                While drd.Read()
                    ...
                    mascotaSel = New Mascota(drd.GetInt32(0), drd.GetString(1), drd.GetString(2), drd.GetChar(3), drd.GetInt16(4), drd.GetDateTime(5), drd.GetString(6))
        ...
        Return mascotaSel
    End Function
    Public Function GetClienteByID(idQuery As Integer) As Cliente
        Dim consulta As String
        consulta = "Select * From cliente WHERE ci_cliente = " & idQuery & ";"
        ...
        Try
            ...
            While drd.HasRows()
                ...
                While drd.Read()
                    ...
                    clienteSel = New Cliente(drd.GetInt32(0), drd.GetString(1), drd.GetInt32(2), drd.GetInt32(3), drd.GetString(4), drd.GetString(5))
        ...
        Return clienteSel
    End Function
    Public Function GetReservaByID(idQuery As Integer) As Hospeda
        Dim consulta As String
        consulta = "Select * From hospeda WHERE num_reserva = " & idQuery & ";"
        ...
        Dim selectedHospeda As Hospeda
        Try
            ...
            While drd.HasRows()
                ...
                While drd.Read()
                    ...
                    If drd.IsDBNull(12) AndAlso drd.IsDBNull(7) = False Then
                        selectedHospeda = New Hospeda(drd.GetString(0), drd.GetInt32(1), drd.GetInt32(2), drd.GetString(3), drd.GetString(4), drd.GetString(5), drd.GetInt32(6), drd.GetInt32(7), drd.GetString(8), drd.GetInt32(9), drd.GetInt32(10), drd.GetInt32(11))

                    ElseIf drd.IsDBNull(7) AndAlso drd.IsDBNull(12) = False Then
                        selectedHospeda = New Hospeda(drd.GetString(0), drd.GetInt32(1), drd.GetInt32(2), drd.GetString(3), drd.GetString(4), drd.GetString(5), drd.GetInt32(6), drd.GetInt32(12), drd.GetString(8), drd.GetInt32(9), drd.GetInt32(10), drd.GetInt32(11))
    ...
    Public Function getClientes() As Cliente()
        Dim consulta As String
        consulta = "Select * From cliente ORDER BY ci_cliente;"
